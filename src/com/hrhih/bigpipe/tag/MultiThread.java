...
@StrutsTag(name = "multiThread", tldTagClass = "com.hrhih.bigpipe.tag.MultiThreadTag", description = "MultiThread Tag")
public class MultiThread extends Component {
	...
	public boolean start(Writer writer) {
		...
		try {
			writer.write("<script type='text/javascript' src='" + bigPipeJSPath + "'></script>");
		} catch (IOException e) {
			e.printStackTrace();
		}
		return start;
