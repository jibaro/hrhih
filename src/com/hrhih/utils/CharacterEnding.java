...
public class CharacterEnding {
	 ...
	 *            要分析的文件
	 */
	public synchronized static String getCharset(BufferedInputStream bis) {
...
//				System.out.println(loc + " " + Integer.toHexString(read));
	...
	public static void main(String[] args) {
		...
		String filePath = "D:/test/hrhih/img.jpg";

		String type = CharacterEnding.getCharset(filePath);
