...
CREATE TABLE `T_Province` (
  ...
  `ProSort` int(8) NOT NULL,			
  `ProRemark` varchar(64) ,	
  `pingyin` varchar(128) ,	
  `szm` varchar(32) ,
  `seqnum` int(8) ,
  PRIMARY KEY (`ProID`)
...
insert T_Province(ProName,ProSort,ProRemark) Values('新疆维吾尔自治区','31','自治区');
...
insert T_Province(ProName,ProSort,ProRemark) Values('其它国家或地区','35','国外');
...
INSERT T_City(CityName,ProID,CitySort) Values('美国','35','372');
INSERT T_City(CityName,ProID,CitySort) Values('英国','35','373');
INSERT T_City(CityName,ProID,CitySort) Values('法国','35','374');
INSERT T_City(CityName,ProID,CitySort) Values('日本','35','375');
INSERT T_City(CityName,ProID,CitySort) Values('俄罗斯','35','376');
INSERT T_City(CityName,ProID,CitySort) Values('巴西','35','377');
INSERT T_City(CityName,ProID,CitySort) Values('南非','35','378');
INSERT T_City(CityName,ProID,CitySort) Values('澳大利亚','35','379');
INSERT T_City(CityName,ProID,CitySort) Values('加拿大','35','380');
INSERT T_City(CityName,ProID,CitySort) Values('韩国','35','380');
INSERT T_City(CityName,ProID,CitySort) Values('印度','35','382');
INSERT T_City(CityName,ProID,CitySort) Values('巴基斯坦','35','383');
INSERT T_City(CityName,ProID,CitySort) Values('德国','35','384');
INSERT T_City(CityName,ProID,CitySort) Values('意大利','35','385');
INSERT T_City(CityName,ProID,CitySort) Values('其他','35','386');
